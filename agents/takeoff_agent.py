...
from .critic_network_takeoff import Critic_Takeoff
from .actor_network_takeoff import Actor_Takeoff
from .replay_memory_takeoff import Replay_Buffer_Takeoff
from .noise_generator import OUNoise
from quad_controller_rl.agents.base_agent import BaseAgent


class Takeoff_DDPG(BaseAgent):
    def __init__(self,task):
        ...
        self.actor_local = Actor_Takeoff(self.state_size,self.action_size,
                                             self.action_low,self.action_high)
        self.actor_target = Actor_Takeoff(self.state_size,self.action_size,
                                             self.action_low,self.action_high)
   
        #Critic (Value) Model
        self.critic_local = Critic_Takeoff(self.state_size, self.action_size)
        self.critic_target = Critic_Takeoff(self.state_size, self.action_size)
    ...
    def reset_episode_vars(self):
        ...
        self.batch_size= 64
        self.memory = Replay_Buffer_Takeoff(self.buffer_size)
